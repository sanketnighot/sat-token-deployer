...
export default function HomePage() {
    ...
    return (
        <>
            <Navbar />
            <div className="flex flex-col items-center justify-center fixed absolute left-0 z-10 w-full h-full bg-gradient-to-r from-blue-700 to-pink-700 overflow-y-auto">
