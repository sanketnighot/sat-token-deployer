            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="flex justify-between">
                    ...
                    <div className="hidden md:flex space-x-2">
                        <button className="px-4 py-2 bg-black-500 text-white rounded hover:bg-black-600 transition duration-300" onClick={!account ? onConnectWallet : onDisconnectWallet}>
