...
const Collection = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="flex flex-col items-center justify-center fixed top-0 left-0 z-10 w-full h-full bg-gradient-to-r from-green-700 to-yellow-700 min-h-screen">
