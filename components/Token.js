...
const Token = ({ collectionName, collectionAdmin, collectionDescription, setShowToken }) => {
    ...
    return (
        <div className="flex flex-col items-center sm:justify-center md:jstify-center fixed inset-y-12 lg:top-10 left-0 z-10 w-full h-full bg-gradient-to-r from-sky-700 to-yellow-700 min-h-screen overflow-y-auto">
            ...
            <form className="flex flex-col ml-8 mr-8 w-4/6" onSubmit={(e) => { e.preventDefault(); }}>
                ...
                {isTransaction ? <button className="p-2 text-black bg-white rounded mb-5 cursor-wait" disabled>
                    <div role="status">
                ...
                </button> : <div className="flex flex-wrap sm:flex-nowrap mb-44">
                    <button className="p-2 text-black rounded p-2 m-2 bg-white text-center w-full flex text-center justify-center"
                        onClick={async () => {
                            setShowToken(false)
                        }}>
                    ...
                    <button className="p-2 text-white bg-black p-2 m-2 rounded text-center w-full"
                        onClick={async () => {
